...
Database::disconnect();
  ...
  <div class="container p-4 pb-0">
    ...
    <section class="mb-2">
      ...
      <a class="btn btn-outline-light btn-floating m-1" href="https://www.linkedin.com/in/djordje-djuric/" role="button"
        ><i class="fab fa-linkedin-in"></i
      ></a>

      <a class="btn btn-outline-light btn-floating m-1" href="https://github.com/djox00" role="button"
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    Website designed by:
    <p class="text-white" style="display: inline;">Djordje Djuric</p>
  </div>
